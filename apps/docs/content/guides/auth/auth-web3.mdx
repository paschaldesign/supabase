...
```
opensourcetoken.com wants you to sign in with your Ethereum account:
0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2

I accept the ExampleOrg Terms of Service: https://opensourcetoken.com/tos

URI: https://opensourcetoken.com/login
Version: 1
Chain ID: 1
Nonce: 32891756
Issued At: 2021-09-30T16:25:24Z
Resources:
- https://opensourcetoken.com/my-web2-claim.json
```
...
For example if the user is signing in to the page `https://opensourcetoken.com/sign-in` you should add the following configurations in the Redirect URL settings:

- `https://opensourcetoken.com/sign-in/` (last slash is important)
- Alternatively set up a glob pattern such as `https://opensourcetoken.com/**`
...
const { data, error } = await supabase.auth.signInWithWeb3({
  chain: 'ethereum',
  statement: 'I accept the Terms of Service at https://opensourcetoken.com/tos',
})
```
